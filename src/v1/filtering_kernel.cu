...
// making use of the symmetric property of the weights requires thread communication. The disrupted view of the weights and the need of global writes will result eventually to poor performance
